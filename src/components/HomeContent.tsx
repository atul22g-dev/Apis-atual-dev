...
import {
  ...
  Smartphone, Zap, BarChart3, Github, Feather, Mic
} from 'lucide-react';
...
const categoryColors: Record<string, { bg: string; border: string; glow: string }> = {
  ...
  'poetry': { bg: 'from-violet-500/20 to-purple-500/10', border: 'border-violet-500/30', glow: 'group-hover:shadow-violet-500/25' },
  'standup-comedy': { bg: 'from-amber-500/20 to-yellow-500/10', border: 'border-amber-500/30', glow: 'group-hover:shadow-amber-500/25' },
...
export default function HomeContent({ categories }: { categories: CategoryInfo[] }) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {categories.map((cat, i) => {
              ...
              const colors = categoryColors[cat.slug] || categoryColors['frontend']!;
